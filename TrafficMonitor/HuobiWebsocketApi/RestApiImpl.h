...
namespace Huobi {
    ...
    private:
		...
		std::string TradingUrl = "https://api.huobipro.com:443";
		std::string MarketQueryUrl = "https://api.huobipro.com:443";

		std::string subscriptionMarketUrl = "wss://api.huobipro.com:443/ws";
		std::string subscriptionTradingUrl = "wss://api.huobipro.com/ws/v1";
        std::string accessKey;
        std::string secretKey;
        // std::string host = "api.huobi.pro";
		std::string host = "api.huobipro.com";
    public:
