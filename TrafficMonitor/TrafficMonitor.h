...
public:
	...
	double m_btc_price;		//BTC价格
	double m_bch_price;		//BCH价格
	double m_last_btc_price;		//最后一次BTC价格
	double m_last_bch_price;		//最后一次BCH价格
	COLORREF m_last_btc_color;  //最后一次BTC颜色
	COLORREF m_last_bch_color;  //最后一次BCH颜色
